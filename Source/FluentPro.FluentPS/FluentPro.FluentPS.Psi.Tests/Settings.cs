...
namespace FluentPro.FluentPS.Psi.Tests
{
    public static class Settings
    {
        ...
        public static Guid DefaultProjectGuid = new Guid("E337221E-C381-4D99-A06E-35579C1D7932");

        public static Guid DefaultSessionGuid = new Guid("4D7A6E61-448D-42B9-A1DD-D0099155B6C1");
    }
}
