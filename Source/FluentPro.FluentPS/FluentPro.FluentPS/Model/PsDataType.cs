namespace FluentPro.FluentPS.Model
{
    public enum PsDataType
    {
        ...
        Priority = 2,
        ConstraintType = 3,
        Date = 4, // Used in custom fields struct, StartDate and FinishDate in native fields converted to Date to simplify conversions
        Percent = 5,
        Duration = 6, // Used in custom fields struct
        DurationOffset = 7,
        Work = 8, // Used in native fields
        ...
        StatusUpdateType = 48,
        Enum3 = 49,
        PsStrings = 50, // Used for WPROJ_DESCRIPTION, multiline text
        TaskStatus = 51,
        Demreq = 52,
        Evmeth = 53,
        BookingType = 54,
