...
namespace FluentPro.FluentPS.CodeGenerator.Operations.GenerateFromTemplate.Data
{
    public class PredefinedFieldInfos
    {
        ...
        {
            new PsFieldInfo { TableName = "Project", PsName = "WPROJ_DESCRIPTION", DbName = string.Empty, DisplayName = "Description", PsDataType = PsDataType.PsStrings, Uid = new Guid("837aafa9-fa1a-49c0-8a08-6b007865991b"), DataType = typeof(string), IsUpdatable = true },
            new PsFieldInfo { TableName = "Resource", PsName = "NEW_RES_UID", DbName = string.Empty, DisplayName = "Resource New Uid", PsDataType = PsDataType.Guid, Uid = new Guid("847D3B3A-76A7-469E-8AB1-2BBA6D59D856"), DataType = typeof(Guid), IsUpdatable = true }
        };
    }
}
